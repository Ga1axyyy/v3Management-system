...
const handleDelete = (val) => {
  console.log('准备删除的数据 ID:', val.id)
  ElMessageBox.confirm('确定要删除该数据吗？', {
    cancelButtonText: '否',
    confirmButtonText: '是',
  })
    .then(async () => {
      const response = await axios.delete(`/api/user/deleteUser?id=${val.id}`) // 正确的 POST 请求，数据放在请求体中
...
<template>
  ...
  <div class="table">
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column fixed="right" label="操作选项" min-width="120">
